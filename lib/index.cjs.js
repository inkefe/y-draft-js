...
var DMP$1 = new Dmp__default["default"]();

var diffString = function diffString(txt1, txt2) {
  return DMP$1.patch_toText(DMP$1.patch_make(txt1, txt2));
};
...
var onTargetSync = function onTargetSync(path, ymap, cb) {
  ...
  function ob(e) {
    var target = getTargetByPath(path, e.currentTargt, true);
...
window.getRawByState = function (editorState) {
  return draftJs.convertToRaw(editorState.getCurrentContent());
};
...
var DraftBinding = /*#__PURE__*/function () {
  function DraftBinding(opts) {
    ...
    this.bindEditor = function (editor) {
      ...
      if (!draftEditor || !editor.componentDidUpdate) return console.warn('editor must be Draft ref');
  ...
  _proto.destroy = function destroy() {
    ...
    this._onChange && this.draftEditor && (this.draftEditor.onChange = this._onChange);
    this.mutex = null;
