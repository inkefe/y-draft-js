...
var DraftBinding = /*#__PURE__*/function () {
  function DraftBinding(opts) {
    ...
    this.listenTargetYmap = function (rawYmap) {
      ...
      _this.oprID = rawYmap.get(CHANGE_CLIENT);

      if (!_this.oprID) {
        _this.oprID = draftJs.genKey();
        rawYmap.set(CHANGE_CLIENT, _this.oprID);
      }
    ...
    this.bindEditor = function (editor) {
      ...
      if (isPluginEditor) {
        ...
        var that = _this;
        _this._onChange && (editor.onChange = function () {
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
    ...
    var ymap = opts.ymap,
        ...
        updatable = _opts$updatable === void 0 ? true : _opts$updatable; // this.version = "1.3.5";
    ...
    this.onChange = function (editorState) {
      return _this.mutex(function () {
        ...
        _this.editorState = editorState; // console.log('this.onChange');
        ...
        var selectData = {
          ...
          focusOffset: selection.getFocusOffset() // hasFocus: selection.getHasFocus(),

        };
        var hasFocus = selection.getHasFocus();

        if (!lodash.isEqual(_this.selectData, selectData) && _this.selectData) {
          hasFocus = true;
        }
        ...
        _this.awareness.setLocalStateField('selection', _extends({}, selectData, {
          hasFocus: hasFocus
        }));
  ...
  _proto.destroy = function destroy() {
    ...
    this._update && this.draftEditor && (this.draftEditor.update = this._update);
