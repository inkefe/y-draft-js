...
var onTargetSync = function onTargetSync(path, ymap, cb) {
  ...
  function ob(e) {
    var _targetMap$pathKey2;

    var target = getTargetByPath(path, e[0].currentTarget, true);
    if (!target) return; // 等待目标字段的内容出现

    if (((_targetMap$pathKey2 = targetMap[pathKey]) == null ? void 0 : _targetMap$pathKey2.target) === target) return;
...
var DraftBinding = function DraftBinding(opts) {
  ...
  this.listenTargetYmap = function (rawYmap) {
    ...
    _this.value = rbw2raw(_this.rawYmap.toJSON());
