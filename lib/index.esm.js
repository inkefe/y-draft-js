...
import { SelectionState, convertToRaw, EditorState, convertFromRaw } from 'draft-js';
...
var DraftBinding = /*#__PURE__*/function () {
  function DraftBinding(opts) {
    ...
    this.setStateByRaw = function (raw) {
      ...
      var newEditorState = EditorState.push(editorState, convertFromRaw(raw), 'sycn-change');
...
export { DraftBinding, getNewSelection, getRawBySharedData, getTargetByPath, onTargetSync, toRawSharedData, toSyncElement };
