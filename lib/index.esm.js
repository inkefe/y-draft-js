...
var DMP$1 = new Dmp(); // 计算序号, 默认不跟随内容更改
...
var DraftBinding = /*#__PURE__*/function () {
  function DraftBinding(opts) {
    ...
    this.setStateAndSelection = function (_onChange, newEditorState, isCollapsed, raw) {
      ...
      _this.editorState = EditorState[isCollapsed || _this.shouldAcceptSelection ? 'acceptSelection' : 'forceSelection'](newEditorState, newSelection);
      _this.value = raw;
