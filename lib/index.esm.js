...
var onTargetSync = function onTargetSync(path, ydoc, cb, firstType) {
  ...
  var firstData = ydoc.get(fixField, Y.Map);
...
export { DraftBinding, getNewSelection, getRawBySharedData, getTargetByPath, onTargetSync, raw2rbw, rbw2raw, setRawToSharedData, toRawSharedData, toSyncElement };
